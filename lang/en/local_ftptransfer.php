...
$string['ftp_auth'] = 'FTP Authentication Method';
$string['ftp_auth_desc'] = 'Select the authentication method to connect to the FTP server.';
$string['ftp_auth_password'] = 'Password';
$string['ftp_auth_keyfile'] = 'Key File';
$string['ftp_password'] = 'FTP Password';
$string['ftp_password_desc'] = '';
$string['ftp_public_key_file'] = 'FTP Public Key File';
$string['ftp_public_key_file_desc'] = 'The absolute path to the public key file for key file authentication.';
$string['ftp_private_key_file'] = 'FTP Private Key File';
$string['ftp_private_key_file_desc'] = 'The absolute path to the private key file for key file authentication.';
...
$string['ftp_delete_after_transfer'] = 'Delete after Transfer';
$string['ftp_delete_after_transfer_desc'] = 'If enabled, files will be deleted from the FTP server after a successful transfer.';
...
$string['ftp_error_login'] = 'Error logging in to FTP server. Please check the username and password/keyfile.';
$string['ftp_error_unknown_auth'] = 'Error: Unknown authentication method.';
$string['ftp_error_phpextension'] = 'Error: The PHP FTP extension is not installed or enabled on this server.';
...
$string['deleted_file'] = 'File deleted from FTP server:            {$a->filename}.';
$string['error_deleting_file'] = 'Error deleting file from FTP server:     {$a->filename}.';
